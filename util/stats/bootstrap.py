...
if __name__ == "__main__":
    ...
    for i, file_name in enumerate(args.stat_file_names):
        ...
        statistic = statistic_name_map[header["statistic"]]
        stats[f"{statistic}_{sample_id}"] = arr[:, args.col_idx]
    #
    ...
    cols = dict(zip(np.arange(len(stat_names)), stat_names))
    ...
    file_util.save_arr(args.out_file_name, boot_arr, boot_header)
    #
