...
# arg 3: limit: the minimum continuous sequence length to include
...
bcftools merge -o merge_0.vcf.gz -R "$mask_file" "${@:4}"
...
python /c/archaic/src/pyscripts/make_bed.py merge_1.vcf.gz "$out_stem.bed" "$length_limit"
